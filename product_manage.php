                ...
                <div class="row app__content">
                    ...
                    <div class="col l-10">
                        <div class="product__manage-block-heading">
                            ...
                            <button class="product__heading-btn"><a href="./edit_product.php" class="product__heading-btn-link">+ Add Product</a></button>
                        </div>
                            ...
                            ?>
                                <tr class="table__content">
                                    ...
                                    <td class="table__td-action">
                                        <button class="action__btn edit"><a href="./directional.php?action=edit_product" class="action__link">Edit</a></button>
                                        <button class="action__btn del"><a href="./product_manage.php?id=<?= $row['MSHH'] ?>" class="action__link">Delete</a></button>
                                    </td>
                                </tr>
                            <?php } ?>
