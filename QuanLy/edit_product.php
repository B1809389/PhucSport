                    ...
                    <div class="col l-10">
                        ...
                        if (isset($_POST['submit'])) {
                            ...
                            if (mysqli_query($con, $sql)) {
                                ...
                                header('Location: http://localhost/PhucSport/QuanLy/edit_product.php');
                            } else {
                        ...
                        if (isset($_POST['update'])) {
                            ...
                            if (mysqli_query($con, $sql)) {
                                echo "<script> alert('Success');</script>";
                                header('Refresh: 1;url= http://localhost/PhucSport/QuanLy/product_manage.php');
                            } else {
                                echo "<script> alert('Fail');</script>";
                                header('Refresh: 1;url= http://localhost/PhucSport/QuanLy/product_manage.php');
                            }
                        ...
                        ?>
                        <form action="http://localhost/PhucSport/QuanLy/edit_product.php" class="form__add-product" method="POST" enctype="multipart/form-data">
