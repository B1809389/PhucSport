                ...
                <div class="row app__content">
                    ...
                    <div class="col l-10">
                        <div class="product__manage-block-heading">
                            ...
                            <button class="product__heading-btn"><a href="http://localhost/PhucSport/QuanLy/directional.php?action=edit_user" class="action__link">+ Add User</a></button>
                        </div>
                            ...
                            ?>
                                <tr class="table__content">
                                    ...
                                    <td class="table__td-action">
                                        <button class="action__btn edit"><a href="http://localhost/PhucSport/QuanLy/directional.php?action=edit_user" class="action__link">Edit</a></button>
                                        <button class="action__btn del"><a href="http://localhost/PhucSport/QuanLy/user_manage.php?id=<?= $row['MSKH'] ?>" class="action__link">Delete</a></button>
                                    </td>
                                </tr>
                            <?php } ?>
                        </table>
                        ...
                        <table class="table">
                            ...
                            ?>
                                <tr class="table__content">
                                    ...
                                    <td class="table__td-password"><?= $row['Password'] ?></td>
                                    <td class="table__td-action">
                                        <button class="action__btn edit"><a href="http://localhost/PhucSport/QuanLy/directional.php?action=edit" class="action__link">Edit</a></button>
                                        <button class="action__btn del"><a href="http://localhost/PhucSport/QuanLy/user_manage.php?id=<?= $row['MSNV'] ?>" class="action__link">Delete</a></button>
                                    </td>
                                </tr>
