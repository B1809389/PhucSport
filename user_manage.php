                            ...
                            ?>
                                <tr class="table__content">
                                    ...
                                    <td class="table__td-action">
                                        <button class="action__btn edit"><a href="./directional.php?action=edit_user" class="action__link">Edit</a></button>
                                        <button class="action__btn del"><a href="./user_manage.php?id=<?= $row['MSKH'] ?>" class="action__link">Delete</a></button>
                                    </td>
                                </tr>
                            <?php } ?>
                        </table>
                        ...
                        <table class="table">
                            ...
                            ?>
                                <tr class="table__content">
                                    ...
                                    <td class="table__td-password"><?= $row['Password'] ?></td>
                                    <td class="table__td-action">
                                        <button class="action__btn edit"><a href="./directional.php?action=edit" class="action__link">Edit</a></button>
                                        <button class="action__btn del"><a href="./user_manage.php?id=<?= $row['MSNV'] ?>" class="action__link">Delete</a></button>
                                    </td>
                                </tr>
